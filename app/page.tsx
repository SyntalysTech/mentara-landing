      ...
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent} className={mounted ? 'animate-slideUp' : ''}>
          ...
          <div className="hero-buttons" style={styles.heroButtons}>
            <a href="https://apps.apple.com/app/mentara/id6757170861" target="_blank" rel="noopener noreferrer" style={styles.primaryButton}>
              ...
              <span>{t.home.downloadAppStore}</span>
            </a>
